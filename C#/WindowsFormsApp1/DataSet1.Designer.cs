...
namespace WindowsFormsApp1.DataSet1TableAdapters {
    ...
    public partial class EMPLOYEETableAdapter : global::System.ComponentModel.Component {
        ...
        private global::InterBaseSql.Data.InterBaseClient.IBDataAdapter _adapter;
        
        private global::InterBaseSql.Data.InterBaseClient.IBConnection _connection;
        
        private global::InterBaseSql.Data.InterBaseClient.IBTransaction _transaction;
        
        private global::InterBaseSql.Data.InterBaseClient.IBCommand[] _commandCollection;
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected internal global::InterBaseSql.Data.InterBaseClient.IBDataAdapter Adapter {
            get {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        internal global::InterBaseSql.Data.InterBaseClient.IBConnection Connection {
            get {
            ...
            set {
                ...
                for (int i = 0; (i < this.CommandCollection.Length); i = (i + 1)) {
                    if ((this.CommandCollection[i] != null)) {
                        ((global::InterBaseSql.Data.InterBaseClient.IBCommand)(this.CommandCollection[i])).Connection = value;
                    }
                }
            }
        }
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        internal global::InterBaseSql.Data.InterBaseClient.IBTransaction Transaction {
            get {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected global::InterBaseSql.Data.InterBaseClient.IBCommand[] CommandCollection {
            get {
        ...
        private void InitAdapter() {
            this._adapter = new global::InterBaseSql.Data.InterBaseClient.IBDataAdapter();
            ...
            this._adapter.DeleteCommand = new global::InterBaseSql.Data.InterBaseClient.IBCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM ""EMPLOYEE"" WHERE ((""EMPNO"" = @Original_EMPNO) AND ((@IsNull_LASTNAME = 1 AND ""LASTNAME"" IS NULL) OR (""LASTNAME"" = @Original_LASTNAME)) AND ((@IsNull_FIRSTNAME = 1 AND ""FIRSTNAME"" IS NULL) OR (""FIRSTNAME"" = @Original_FIRSTNAME)) AND ((@IsNull_PHONEEXT = 1 AND ""PHONEEXT"" IS NULL) OR (""PHONEEXT"" = @Original_PHONEEXT)) AND ((@IsNull_HIREDATE = 1 AND ""HIREDATE"" IS NULL) OR (""HIREDATE"" = @Original_HIREDATE)) AND ((@IsNull_SALARY = 1 AND ""SALARY"" IS NULL) OR (""SALARY"" = @Original_SALARY)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            global::InterBaseSql.Data.InterBaseClient.IBParameter param = new global::InterBaseSql.Data.InterBaseClient.IBParameter();
            ...
            param = new global::InterBaseSql.Data.InterBaseClient.IBParameter();
            ...
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::InterBaseSql.Data.InterBaseClient.IBParameter();
            param.ParameterName = "@IsNull_PHONEEXT";
            param.DbType = global::System.Data.DbType.Int32;
            param.Size = 4;
            param.IsNullable = true;
            param.SourceColumn = "PHONEEXT";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            param.SourceColumnNullMapping = true;
            this._adapter.DeleteCommand.Parameters.Add(param);
            param = new global::InterBaseSql.Data.InterBaseClient.IBParameter();
            param.ParameterName = "@Original_PHONEEXT";
            param.Size = 4;
            param.IsNullable = true;
            param.SourceColumn = "PHONEEXT";
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            ...
            param.SourceVersion = global::System.Data.DataRowVersion.Original;
            this._adapter.DeleteCommand.Parameters.Add(param);
            this._adapter.InsertCommand = new global::InterBaseSql.Data.InterBaseClient.IBCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO \"EMPLOYEE\" (\"EMPNO\", \"LASTNAME\", \"FIRSTNAME\", \"PHONEEXT\", \"HIREDATE\"," +
                " \"SALARY\") VALUES (@EMPNO, @LASTNAME, @FIRSTNAME, @PHONEEXT, @HIREDATE, @SALARY)" +
                "";
            ...
            param.SourceColumn = "SALARY";
            this._adapter.InsertCommand.Parameters.Add(param);
            this._adapter.UpdateCommand = new global::InterBaseSql.Data.InterBaseClient.IBCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE ""EMPLOYEE"" SET ""EMPNO"" = @EMPNO, ""LASTNAME"" = @LASTNAME, ""FIRSTNAME"" = @FIRSTNAME, ""PHONEEXT"" = @PHONEEXT, ""HIREDATE"" = @HIREDATE, ""SALARY"" = @SALARY WHERE ((""EMPNO"" = @Original_EMPNO) AND ((@IsNull_LASTNAME = 1 AND ""LASTNAME"" IS NULL) OR (""LASTNAME"" = @Original_LASTNAME)) AND ((@IsNull_FIRSTNAME = 1 AND ""FIRSTNAME"" IS NULL) OR (""FIRSTNAME"" = @Original_FIRSTNAME)) AND ((@IsNull_PHONEEXT = 1 AND ""PHONEEXT"" IS NULL) OR (""PHONEEXT"" = @Original_PHONEEXT)) AND ((@IsNull_HIREDATE = 1 AND ""HIREDATE"" IS NULL) OR (""HIREDATE"" = @Original_HIREDATE)) AND ((@IsNull_SALARY = 1 AND ""SALARY"" IS NULL) OR (""SALARY"" = @Original_SALARY)))";
        ...
        private void InitConnection() {
            this._connection = new global::InterBaseSql.Data.InterBaseClient.IBConnection();
        ...
        private void InitCommandCollection() {
            this._commandCollection = new global::InterBaseSql.Data.InterBaseClient.IBCommand[1];
            this._commandCollection[0] = new global::InterBaseSql.Data.InterBaseClient.IBCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT \"EMPNO\", \"LASTNAME\", \"FIRSTNAME\", \"PHONEEXT\", \"HIREDATE\", \"SALARY\" FROM \"E" +
                "MPLOYEE\"";
        ...
        public virtual int Delete(int Original_EMPNO, string Original_LASTNAME, string Original_FIRSTNAME, string Original_PHONEEXT, global::System.Nullable<global::System.DateTime> Original_HIREDATE, global::System.Nullable<double> Original_SALARY) {
        ...
        public virtual int Insert(int EMPNO, string LASTNAME, string FIRSTNAME, string PHONEEXT, global::System.Nullable<global::System.DateTime> HIREDATE, global::System.Nullable<double> SALARY) {
        ...
        public virtual int Update(int EMPNO, string LASTNAME, string FIRSTNAME, string PHONEEXT, global::System.Nullable<global::System.DateTime> HIREDATE, global::System.Nullable<double> SALARY, int Original_EMPNO, string Original_LASTNAME, string Original_FIRSTNAME, string Original_PHONEEXT, global::System.Nullable<global::System.DateTime> Original_HIREDATE, global::System.Nullable<double> Original_SALARY) {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_EMPNO));
            if ((Original_LASTNAME == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string LASTNAME, string FIRSTNAME, string PHONEEXT, global::System.Nullable<global::System.DateTime> HIREDATE, global::System.Nullable<double> SALARY, int Original_EMPNO, string Original_LASTNAME, string Original_FIRSTNAME, string Original_PHONEEXT, global::System.Nullable<global::System.DateTime> Original_HIREDATE, global::System.Nullable<double> Original_SALARY) {
        ...
        public virtual int UpdateAll(DataSet1 dataSet) {
            ...
            try {
                ...
                if ((this._eMPLOYEETableAdapter != null)) {
                    ...
                    this._eMPLOYEETableAdapter.Connection = ((global::InterBaseSql.Data.InterBaseClient.IBConnection)(workConnection));
                    this._eMPLOYEETableAdapter.Transaction = ((global::InterBaseSql.Data.InterBaseClient.IBTransaction)(workTransaction));
                ...
                if ((this._eMPLOYEETableAdapter != null)) {
                    this._eMPLOYEETableAdapter.Connection = ((global::InterBaseSql.Data.InterBaseClient.IBConnection)(revertConnections[this._eMPLOYEETableAdapter]));
